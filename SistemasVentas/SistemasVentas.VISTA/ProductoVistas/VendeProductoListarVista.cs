...
{
    public partial class VendeProductoListarVista : Form
    {
        public VendeProductoListarVista()
        {
            InitializeComponent();
        }
        ...
        {
            CompraProductoVista.IdProductoSeleccionado = Convert.ToInt32(dataGridView1.CurrentRow.Cells[0].Value);
        ...
        private void VendeProductoListarVista_Load(object sender, EventArgs e)
        {
