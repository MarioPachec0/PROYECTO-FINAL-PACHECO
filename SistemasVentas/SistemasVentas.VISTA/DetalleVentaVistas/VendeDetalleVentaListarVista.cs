...
{
    public partial class VendeDetalleVentaListarVista : Form
    {
        public VendeDetalleVentaListarVista()
        {
            InitializeComponent();
        }
        DetalleVentaBss bss = new DetalleVentaBss();
        private void VendeDetalleVentaListarVista_Load(object sender, EventArgs e)
        {
